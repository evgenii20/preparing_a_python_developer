...
def forward(app, se):
    ...
    ProductCatalog.objects.using(alias).bulk_create([
        ProductCatalog(name='Куртка', dates='2022-05-29', price=150, unit='шт', name_supplier='ООО Куртка опт'),
        ProductCatalog(name='Джинсы', dates='2022-05-29', price=200, unit='шт', name_supplier='ООО Джинсы')
    ])
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalogapp', '0004_rename_catalog_productcatalog'),
    ]
